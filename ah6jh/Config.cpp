...
class CfgPatches {
	class AH6HF {
		units[] = {"AH6JH_FLIR_GAU", "AH6JH_FLIR_HF", "AH6JH_GAU8"};
		weapons[] = {};
		magazines[] = {};
...
class CfgVehicles {
	...
	/* GAU-8/19x70HE :D */
	class AH6JH_GAU8 : AH6JH_Base {
		displayName = "AH-6J/H (GAU-8/19x70HE :D)";
		...
		weapons[] = {"FFARLauncher", ACE_GAU8, "CMFlareLauncher"};
		magazines[] = {"ACE_19Rnd_70mm_FFAR_HE", "ACE_1350Rnd_30mmAP_A10", "60Rnd_CMFlareMagazine"};
